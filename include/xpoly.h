...
**
**		Jack,2003.5.12.
**			--- Modify struct define POLY: change reserved1 to touch_line.
**			--- Add function D3_get_poly_underside_touch_line().
**
*/
...
PDP_TOUCHLINE		=	0x00000800,		// draw touchline of the poly
...
typedef struct tagPOLY
{
   ...
   UCHR		touch_line;		// 當作為出入口事件區域時,紀錄觸發線索引值(0=未指定,1=P0P1連線,...)
   UCHR     reserved2;      // 保留值2
...
EXPORT	SLONG	FNBACK	D3_get_poly_underside_touch_line(POLY *pl, SLONG *x1, SLONG *y1, SLONG *z1, SLONG *x2, SLONG *y2, SLONG *z2);
...
EXPORT	SLONG	FNBACK	compute_enter_line_points(SLONG *x1, SLONG *y1, SLONG *z1, 
												  SLONG *x2, SLONG *y2, SLONG *z2, 
												  SLONG px, SLONG py, SLONG pz);
EXPORT	double	FNBACK	compute_enter_t(POLY *poly, SLONG px, SLONG py, SLONG pz);
EXPORT	void	FNBACK	compute_enter_t_point(SLONG x1, SLONG y1, SLONG z1, SLONG x2, SLONG y2, SLONG z2, double t, 
