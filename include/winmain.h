...
extern	DWORD		g_dwRaysSDKVersion;	/* rayssdk version */

extern	int (*RaysDDWinMain)(HINSTANCE hInstance, HINSTANCE hPrevInstance, 
...
/*------------------------------------------------------------------------------------------*/
EXPORT	void	FNBACK	SetRaysSDKVersion(DWORD dwVersion);
//
...
EXPORT	void	FNBACK	SetDDWndCtrlColorProc(WNDPROC pfn);
